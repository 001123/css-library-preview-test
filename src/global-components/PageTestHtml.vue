    ...
    >
      <section id="text">
        ...
        <article id="text__paragraphs">
          ...
          <div>
            <p>
              A paragraph (from the Greek paragraphos, “to write beside” or “written beside”) is a self-contained unit of a discourse in writing dealing with a particular point or idea. A paragraph consists of one or more
  ...
  p q r s t u v w x y z { | } ~
        ...
        <article id="text__inline">
          ...
          <div>
            ...
            <p>
              The
              <var>variable element</var>, such as <var>x</var> = <var>y</var>.
            </p>
            <p>
              The time element:
